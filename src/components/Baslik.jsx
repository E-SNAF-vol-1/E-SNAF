...
export default function Baslik() {
    ...
    return (
        <header className="sticky top-0 z-50 bg-[#ede6ca]/30 backdrop-blur-md border-b border-[#d2b48c]/30 shadow-sm text-[#5d4037]">
                ...
                <div className="flex items-center justify-between h-20 gap-8">
                    ...
                    <div className="hidden md:flex flex-grow max-w-md relative">
                        <input
                            ...
                            className="w-full bg-white border border-[#d2b48c]/20 rounded-full py-2.5 px-6 focus:outline-none focus:ring-2 focus:ring-[#5d4037]/10 text-sm font-light placeholder:text-[#5d4037]/40 shadow-sm" />
                        <button className="absolute right-4 top-1/2 -translate-y-1/2 opacity-40 hover:opacity-100 transition-opacity cursor-pointer">
