            ...
            function renderPreviews() {
              ...
              selectedFiles.forEach((file, index) => {
                ...
                reader.onload = function(e) {
                  ...
                  meta.className = 'meta';
                  meta.textContent = 'Hazır boyut: 110x110';
            ...
            <form action="/Admin/update-product/${product.id}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="upload-box">
                  ...
                  <small style="color: #666; display: block; margin-top: 5px;">💡 Birden fazla görsel seçebilirsiniz. Her görsel 110x110 boyutuna dönüştürülür ve ürün adına göre adlandırılır.</small>
